...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'survive_100', titleTR: 'Ebedi Başkan', titleEN: 'Eternal President', descTR: '75 tur hayatta kal', descEN: 'Survive 75 turns', emoji: '🏛️', hidden: false, apReward: 150 },
  ...
  { id: 'rich_100', titleTR: 'Zengin Devlet', titleEN: 'Rich State', descTR: '256B hazineye ulaş', descEN: 'Reach 256B treasury', emoji: '💰', hidden: false, apReward: 15 },
  { id: 'rich_500', titleTR: 'Altın Çağ', titleEN: 'Golden Age', descTR: '512B hazineye ulaş', descEN: 'Reach 512B treasury', emoji: '💎', hidden: false, apReward: 40 },
  { id: 'bribe_10', titleTR: 'Rüşvetçi', titleEN: 'The Briber', descTR: 'Toplam 50 kez rüşvet ver', descEN: 'Bribe 50 times total', emoji: '🤝', hidden: false, apReward: 20 },
  { id: 'max_faction', titleTR: 'Mutlak Sadakat', titleEN: 'Absolute Loyalty', descTR: 'En az üç zümreyi aynı anda 100\'e çıkar', descEN: 'Max out at least 3 factions to 100 at the same time', emoji: '📊', hidden: false, apReward: 25 },
  { id: 'launder_5', titleTR: 'Kara Para Uzmanı', titleEN: 'Money Laundering Expert', descTR: '50 kez para akla', descEN: 'Launder money 50 times', emoji: '🧹', hidden: false, apReward: 15 },
