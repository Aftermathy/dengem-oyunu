...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'survive_10', titleTR: 'Acemi Diktatör', titleEN: 'Rookie Dictator', descTR: '10 tur hayatta kal', descEN: 'Survive 10 turns', emoji: '🎯', hidden: false, apReward: 10 },
  ...
  { id: 'rich_100', titleTR: 'Zengin Devlet', titleEN: 'Rich State', descTR: '100B hazineye ulaş', descEN: 'Reach 100B treasury', emoji: '💰', hidden: false, apReward: 15 },
  ...
  { id: 'bribe_10', titleTR: 'Rüşvetçi', titleEN: 'The Briber', descTR: 'Toplam 10 kez rüşvet ver', descEN: 'Bribe 10 times total', emoji: '🤝', hidden: false, apReward: 20 },
  ...
  { id: 'launder_5', titleTR: 'Kara Para Uzmanı', titleEN: 'Money Laundering Expert', descTR: '5 kez para akla', descEN: 'Launder money 5 times', emoji: '🧹', hidden: false, apReward: 15 },
