...
// Legendary: cost 15B, effect 7-8% (special exceptions possible)
...
const electionsTr: ElectionConfig[] = [
  {
    ...
    playerCards: [
      ...
      { id: 4, text: "Ücretsiz kömür dağıt", emoji: "🪨", voterEffect: 4, cost: 6, rarity: 'uncommon' },
  ...
  },
  {
    ...
    playerCards: [
      ...
      { id: 33, text: "Esnaf ziyareti yap", emoji: "🏪", voterEffect: 3, cost: 3, rarity: 'common' },
  ...
  },
  {
    ...
    playerCards: [
      ...
      { id: 45, text: "Miting maratonu başlat", emoji: "🎤", voterEffect: 4, cost: 6, rarity: 'uncommon' },
...
const electionsEn: ElectionConfig[] = [
  {
    ...
    playerCards: [
      ...
      { id: 4, text: "Distribute free coal", emoji: "🪨", voterEffect: 4, cost: 6, rarity: 'uncommon' },
  ...
  },
  {
    ...
    playerCards: [
      ...
      { id: 33, text: "Visit shopkeepers", emoji: "🏪", voterEffect: 3, cost: 3, rarity: 'common' },
  ...
  },
  {
    ...
    playerCards: [
      ...
      { id: 45, text: "Start rally marathon", emoji: "🎤", voterEffect: 4, cost: 6, rarity: 'uncommon' },
