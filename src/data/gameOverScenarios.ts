...
export const gameOverScenarios: GameOverScenario[] = [
  ...
  },
  {
    power: 'tarikat',
    direction: 'low',
    title: 'Tarikat Darbesi!',
    description: 'Tasfiye ettiğini sandığın yapı, devletin her kademesine sızmıştı. Bir gece yarısı telefonlar çaldı, ama arayan senin adamların değildi. Yargıçlar tutuklama kararı çıkardı, emniyet seni arıyor. Medya "Hain lider yakalandı" manşetiyle çıktı. Cüppeli figürler devleti devraldı, sen ise dar bir hücrede sabahladın.',
    emoji: '📿',
  ...
  },
  {
    ...
    direction: 'low',
    title: 'Askeri Darbe!',
    description: 'Tanklar sokağa indi, savaş uçakları çatıları sıyıra sıyıra geçiyor. Yüksek Komuta Konseyi bildiri yayınladı: "Yönetim el değiştirdi." Parlamento binası kuşatıldı, bakanlar gözaltına alındı. Sen sarayda kıstırıldın, kaçış yolu yok. Askeri cunta yönetimi ele aldı, sıkıyönetim ilan edildi. Tahtın artık bir generalin.',
    emoji: '🪖',
    image: 'defeat-ordu',
  },
];
