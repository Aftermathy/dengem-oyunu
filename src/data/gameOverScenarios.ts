...
export const gameOverScenarios: GameOverScenario[] = [
  ...
  },
  {
    ...
    direction: 'low',
    title: 'Askeri Darbe!',
    description: 'Tanklar sokağa indi, F-16\'lar alçaktan geçiyor. Genelkurmay bildiri yayınladı: "Yönetim el değiştirdi." Meclis kuşatıldı, bakanlar gözaltına alındı. Sen sarayda kıstırıldın, kaçış yolu yok. Askeri cunta yönetimi ele aldı, sıkıyönetim ilan edildi. Tahtın artık bir generalin.',
    emoji: '🪖',
    image: 'defeat-ordu',
  },
];
