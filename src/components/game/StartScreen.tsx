    ...
    <div className="flex flex-col items-center justify-center gap-5 p-6 text-center animate-fade-in min-h-screen">
      ...
      <div className="flex flex-col items-center gap-2 pb-4">
        ...
        <a
          ...
          className="flex items-center gap-2 bg-black text-white px-5 py-2.5 rounded-xl text-sm font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200 border border-white/10"
        >
